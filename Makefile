...
pkgdatadir = $(datadir)/statsite
pkgincludedir = $(includedir)/statsite
pkglibdir = $(libdir)/statsite
pkglibexecdir = $(libexecdir)/statsite
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/ac_config/ltmain.sh \
	$(top_srcdir)/ac_config/missing
...
am__v_at_1 = 
DEFAULT_INCLUDES = -I.
depcomp = $(SHELL) $(top_srcdir)/ac_config/depcomp
...
am__v_CCLD_1 = 
SOURCES = $(src_statsite_SOURCES)
DIST_SOURCES = $(src_statsite_SOURCES)
...
PACKAGE_STRING = statsite 0.0.1
PACKAGE_TARNAME = statsite
PACKAGE_URL = 
...
src/statsite$(EXEEXT): $(src_statsite_OBJECTS) $(src_statsite_DEPENDENCIES) $(EXTRA_src_statsite_DEPENDENCIES) src/$(am__dirstamp)
	...
	$(AM_V_CCLD)$(LINK) $(src_statsite_OBJECTS) $(src_statsite_LDADD) $(LIBS)
...
include src/$(DEPDIR)/cm_quantile.Po
include src/$(DEPDIR)/config.Po
include src/$(DEPDIR)/conn_handler.Po
include src/$(DEPDIR)/counter.Po
include src/$(DEPDIR)/hashmap.Po
include src/$(DEPDIR)/heap.Po
include src/$(DEPDIR)/hll.Po
include src/$(DEPDIR)/hll_constants.Po
include src/$(DEPDIR)/metrics.Po
include src/$(DEPDIR)/networking.Po
include src/$(DEPDIR)/radix.Po
include src/$(DEPDIR)/set.Po
include src/$(DEPDIR)/statsite.Po
include src/$(DEPDIR)/streaming.Po
