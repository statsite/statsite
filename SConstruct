...
if ARGUMENTS.get('VERBOSE') != "1":
   env_statsite_with_err['CCCOMSTR'] = "Compiling $TARGET"
   env_statsite_with_err['LINKCOMSTR'] = "Linking $TARGET"
   env_statsite_without_err['CCCOMSTR'] = "Compiling $TARGET"
   env_statsite_without_err['LINKCOMSTR'] = "Linking $TARGET"
